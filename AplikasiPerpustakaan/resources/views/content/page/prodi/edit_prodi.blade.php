		...
		<div class="box box-info">
			...
			<div class="box-body">
				<form method="POST" action="{{ url('/prodi') }}">
					...
					<input type="hidden" name="nama_prodi_lama" value="{{ $edit->nama_prodi }}">
					<div class="form-group">
						<label class="control-label" for="nama_prodi"> Nama Prodi </label>
						<input type="text" class="form-control" id="nama_prodi" name="nama_prodi" placeholder="Masukkan Nama Prodi" autocomplete="off" value="{{ $edit->nama_prodi }}">
					</div>
					<hr>
					<div class="form-group">
