		...
		<div class="box box-info">
			...
			<div class="box-body">
				<form method="POST" action="{{ url('/kategori') }}">
					...
					<input type="hidden" name="nama_lama" value="{{ $edit->nama_kategori }}">
					<div class="form-group">
						<label class="control-label" for="nama_kategori"> Nama Kategori </label>
						<input type="text" class="form-control" id="nama_kategori" name="nama_kategori" placeholder="Masukkan Nama Kategori" value="{{ $edit->nama_kategori }}" autocomplete="off">
					</div>
					<hr>
					<div class="form-group">
